...
export const MODELWithUpperCaseFindFirstArgsSchema: z.ZodType<Prisma.MODELWithUpperCaseFindFirstArgs> = z.object({
...
export default MODELWithUpperCaseFindFirstArgsSchema
