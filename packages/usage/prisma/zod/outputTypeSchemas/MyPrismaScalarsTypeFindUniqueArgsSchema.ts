...
export const MyPrismaScalarsTypeFindUniqueArgsSchema: z.ZodType<Prisma.MyPrismaScalarsTypeFindUniqueArgs> = z.object({
  select: MyPrismaScalarsTypeSelectSchema.optional(),
  where: MyPrismaScalarsTypeWhereUniqueInputSchema,
}).strict()

export default MyPrismaScalarsTypeFindUniqueArgsSchema
