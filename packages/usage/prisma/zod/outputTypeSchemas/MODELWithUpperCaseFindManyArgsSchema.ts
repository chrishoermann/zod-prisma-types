...
export const MODELWithUpperCaseFindManyArgsSchema: z.ZodType<Prisma.MODELWithUpperCaseFindManyArgs> = z.object({
...
export default MODELWithUpperCaseFindManyArgsSchema
