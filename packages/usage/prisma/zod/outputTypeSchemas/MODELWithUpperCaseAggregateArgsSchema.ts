...
export const MODELWithUpperCaseAggregateArgsSchema: z.ZodType<Prisma.MODELWithUpperCaseAggregateArgs> = z.object({
...
export default MODELWithUpperCaseAggregateArgsSchema
