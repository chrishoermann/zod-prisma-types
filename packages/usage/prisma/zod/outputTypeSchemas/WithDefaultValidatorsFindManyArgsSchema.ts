...
export const WithDefaultValidatorsFindManyArgsSchema: z.ZodType<Prisma.WithDefaultValidatorsFindManyArgs> = z.object({
...
export default WithDefaultValidatorsFindManyArgsSchema
