...
export const MyPrismaScalarsTypeFindFirstArgsSchema: z.ZodType<Prisma.MyPrismaScalarsTypeFindFirstArgs> = z.object({
...
export default MyPrismaScalarsTypeFindFirstArgsSchema
