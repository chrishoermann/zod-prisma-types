...
export const ModelWithOmitFieldsFindManyArgsSchema: z.ZodType<Prisma.ModelWithOmitFieldsFindManyArgs> = z.object({
...
export default ModelWithOmitFieldsFindManyArgsSchema
