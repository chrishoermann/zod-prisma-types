...
export const ModelWithOmitFieldsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ModelWithOmitFieldsFindFirstOrThrowArgs> = z.object({
...
export default ModelWithOmitFieldsFindFirstOrThrowArgsSchema
