...
export const MyModelScalarFieldEnum = z.nativeEnum(Prisma.Prisma.MyModelScalarFieldEnum);

export const MyPrismaScalarsTypeScalarFieldEnum = z.nativeEnum(Prisma.Prisma.MyPrismaScalarsTypeScalarFieldEnum);
...
export const MyModelSelect: z.ZodType<Prisma.Prisma.MyModelSelect> = z.object({
...
export const MyPrismaScalarsTypeSelect: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeSelect> = z.object({
  id: z.boolean().optional(),
...
export const MyModelWhereInput: z.ZodType<Prisma.Prisma.MyModelWhereInput> = z.object({
  AND: z.union([z.lazy(() => MyModelWhereInput), z.lazy(() => MyModelWhereInput).array()]).optional(),
  OR: z.lazy(() => MyModelWhereInput).array().optional(),
  NOT: z.union([z.lazy(() => MyModelWhereInput), z.lazy(() => MyModelWhereInput).array()]).optional(),
  id: z.union([z.lazy(() => IntFilter), z.number()]).optional(),
  custom: z.union([z.lazy(() => StringNullableFilter), z.string()]).optional().nullable(),
}).strict();

export const MyModelOrderByWithRelationInput: z.ZodType<Prisma.Prisma.MyModelOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyModelWhereUniqueInput: z.ZodType<Prisma.Prisma.MyModelWhereUniqueInput> = z.object({
  id: z.number().optional(),
}).strict();

export const MyModelOrderByWithAggregationInput: z.ZodType<Prisma.Prisma.MyModelOrderByWithAggregationInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
  _count: z.lazy(() => MyModelCountOrderByAggregateInput).optional(),
  _avg: z.lazy(() => MyModelAvgOrderByAggregateInput).optional(),
  _max: z.lazy(() => MyModelMaxOrderByAggregateInput).optional(),
  _min: z.lazy(() => MyModelMinOrderByAggregateInput).optional(),
  _sum: z.lazy(() => MyModelSumOrderByAggregateInput).optional(),
}).strict();

export const MyModelScalarWhereWithAggregatesInput: z.ZodType<Prisma.Prisma.MyModelScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([z.lazy(() => MyModelScalarWhereWithAggregatesInput), z.lazy(() => MyModelScalarWhereWithAggregatesInput).array()]).optional(),
  OR: z.lazy(() => MyModelScalarWhereWithAggregatesInput).array().optional(),
  NOT: z.union([z.lazy(() => MyModelScalarWhereWithAggregatesInput), z.lazy(() => MyModelScalarWhereWithAggregatesInput).array()]).optional(),
  id: z.union([z.lazy(() => IntWithAggregatesFilter), z.number()]).optional(),
  custom: z.union([z.lazy(() => StringNullableWithAggregatesFilter), z.string()]).optional().nullable(),
}).strict();
...
export const MyPrismaScalarsTypeWhereInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeWhereInput> = z.object({
  AND: z.union([z.lazy(() => MyPrismaScalarsTypeWhereInput), z.lazy(() => MyPrismaScalarsTypeWhereInput).array()]).optional(),
  OR: z.lazy(() => MyPrismaScalarsTypeWhereInput).array().optional(),
  NOT: z.union([z.lazy(() => MyPrismaScalarsTypeWhereInput), z.lazy(() => MyPrismaScalarsTypeWhereInput).array()]).optional(),
  id: z.union([z.lazy(() => StringFilter), z.string()]).optional(),
  string: z.union([z.lazy(() => StringNullableFilter), z.string()]).optional().nullable(),
  bic: z.union([z.lazy(() => StringNullableFilter), z.string()]).optional().nullable(),
  float: z.union([z.lazy(() => FloatFilter), z.number()]).optional(),
  decimal: z.union([z.lazy(() => DecimalFilter), z.number().refine((v) => Decimal.isDecimal(v), { message: 'Must be a Decimal' })]).optional(),
  date: z.union([z.lazy(() => DateTimeNullableFilter), z.date()]).optional().nullable(),
  bigInt: z.union([z.lazy(() => BigIntFilter), z.bigint()]).optional(),
  json: z.lazy(() => JsonFilter).optional(),
  bytes: z.union([z.lazy(() => BytesFilter), z.instanceof(Buffer)]).optional(),
  custom: z.union([z.lazy(() => StringNullableFilter), z.string()]).optional().nullable(),
...
export const MyPrismaScalarsTypeOrderByWithRelationInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
...
export const MyPrismaScalarsTypeWhereUniqueInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeWhereUniqueInput> = z.object({
  id: z.string().optional(),
}).strict();

export const MyPrismaScalarsTypeOrderByWithAggregationInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeOrderByWithAggregationInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  string: z.lazy(() => SortOrder).optional(),
  bic: z.lazy(() => SortOrder).optional(),
  float: z.lazy(() => SortOrder).optional(),
  ...
  bytes: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
  _count: z.lazy(() => MyPrismaScalarsTypeCountOrderByAggregateInput).optional(),
  _avg: z.lazy(() => MyPrismaScalarsTypeAvgOrderByAggregateInput).optional(),
  _max: z.lazy(() => MyPrismaScalarsTypeMaxOrderByAggregateInput).optional(),
  _min: z.lazy(() => MyPrismaScalarsTypeMinOrderByAggregateInput).optional(),
  _sum: z.lazy(() => MyPrismaScalarsTypeSumOrderByAggregateInput).optional(),
}).strict();

export const MyPrismaScalarsTypeScalarWhereWithAggregatesInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([z.lazy(() => MyPrismaScalarsTypeScalarWhereWithAggregatesInput), z.lazy(() => MyPrismaScalarsTypeScalarWhereWithAggregatesInput).array()]).optional(),
  OR: z.lazy(() => MyPrismaScalarsTypeScalarWhereWithAggregatesInput).array().optional(),
  NOT: z.union([z.lazy(() => MyPrismaScalarsTypeScalarWhereWithAggregatesInput), z.lazy(() => MyPrismaScalarsTypeScalarWhereWithAggregatesInput).array()]).optional(),
  id: z.union([z.lazy(() => StringWithAggregatesFilter), z.string()]).optional(),
  string: z.union([z.lazy(() => StringNullableWithAggregatesFilter), z.string()]).optional().nullable(),
  bic: z.union([z.lazy(() => StringNullableWithAggregatesFilter), z.string()]).optional().nullable(),
  float: z.union([z.lazy(() => FloatWithAggregatesFilter), z.number()]).optional(),
  decimal: z.union([z.lazy(() => DecimalWithAggregatesFilter), z.number().refine((v) => Decimal.isDecimal(v), { message: 'Must be a Decimal' })]).optional(),
  date: z.union([z.lazy(() => DateTimeNullableWithAggregatesFilter), z.date()]).optional().nullable(),
  bigInt: z.union([z.lazy(() => BigIntWithAggregatesFilter), z.bigint()]).optional(),
  json: z.lazy(() => JsonWithAggregatesFilter).optional(),
  bytes: z.union([z.lazy(() => BytesWithAggregatesFilter), z.instanceof(Buffer)]).optional(),
  custom: z.union([z.lazy(() => StringNullableWithAggregatesFilter), z.string()]).optional().nullable(),
...
export const MyModelCreateInput: z.ZodType<Prisma.Prisma.MyModelCreateInput> = z.object({
  custom: z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()).optional().nullable(),
}).strict();

export const MyModelUncheckedCreateInput: z.ZodType<Prisma.Prisma.MyModelUncheckedCreateInput> = z.object({
  id: z.number().optional(),
  custom: z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()).optional().nullable(),
}).strict();

export const MyModelUpdateInput: z.ZodType<Prisma.Prisma.MyModelUpdateInput> = z.object({
  custom: z.union([z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
}).strict();

export const MyModelUncheckedUpdateInput: z.ZodType<Prisma.Prisma.MyModelUncheckedUpdateInput> = z.object({
  id: z.union([z.number(), z.lazy(() => IntFieldUpdateOperationsInput)]).optional(),
  custom: z.union([z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
}).strict();

export const MyModelCreateManyInput: z.ZodType<Prisma.Prisma.MyModelCreateManyInput> = z.object({
  id: z.number().optional(),
  custom: z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()).optional().nullable(),
}).strict();

export const MyModelUpdateManyMutationInput: z.ZodType<Prisma.Prisma.MyModelUpdateManyMutationInput> = z.object({
  custom: z.union([z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
}).strict();

export const MyModelUncheckedUpdateManyInput: z.ZodType<Prisma.Prisma.MyModelUncheckedUpdateManyInput> = z.object({
  id: z.union([z.number(), z.lazy(() => IntFieldUpdateOperationsInput)]).optional(),
  custom: z.union([z.string().refine(val => validator.isBIC(val)).transform(val => val.toUpperCase()), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
}).strict();
...
export const MyPrismaScalarsTypeCreateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeCreateInput> = z.object({
...
export const MyPrismaScalarsTypeUncheckedCreateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUncheckedCreateInput> = z.object({
  id: z.string({ invalid_type_error: "invalid type error" }).cuid().optional(),
  string: z.string().min(3, { message: "min error" }).max(10, { message: "max error" }).optional().nullable(),
  bic: z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }).optional().nullable(),
  float: z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }),
...
export const MyPrismaScalarsTypeUpdateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUpdateInput> = z.object({
  id: z.union([z.string({ invalid_type_error: "invalid type error" }).cuid(), z.lazy(() => StringFieldUpdateOperationsInput)]).optional(),
  string: z.union([z.string().min(3, { message: "min error" }).max(10, { message: "max error" }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  bic: z.union([z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  float: z.union([z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }), z.lazy(() => FloatFieldUpdateOperationsInput)]).optional(),
  decimal: z.union([z.number().refine((v) => Decimal.isDecimal(v), { message: 'Must be a Decimal' }), z.lazy(() => DecimalFieldUpdateOperationsInput)]).optional(),
  date: z.union([z.date().min(new Date('2020-01-01')).max(new Date('2020-12-31')), z.lazy(() => NullableDateTimeFieldUpdateOperationsInput)]).optional().nullable(),
  bigInt: z.union([z.bigint(), z.lazy(() => BigIntFieldUpdateOperationsInput)]).optional(),
  json: z.union([z.lazy(() => JsonNullValueInput), InputJsonValue]).optional(),
  bytes: z.union([z.instanceof(Buffer), z.lazy(() => BytesFieldUpdateOperationsInput)]).optional(),
  custom: z.union([z.string().refine((val) => myFunction.validate(val), { message: 'Is not valid' }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
}).strict();

export const MyPrismaScalarsTypeUncheckedUpdateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUncheckedUpdateInput> = z.object({
  id: z.union([z.string({ invalid_type_error: "invalid type error" }).cuid(), z.lazy(() => StringFieldUpdateOperationsInput)]).optional(),
  string: z.union([z.string().min(3, { message: "min error" }).max(10, { message: "max error" }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  bic: z.union([z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  float: z.union([z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }), z.lazy(() => FloatFieldUpdateOperationsInput)]).optional(),
...
export const MyPrismaScalarsTypeCreateManyInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeCreateManyInput> = z.object({
  id: z.string({ invalid_type_error: "invalid type error" }).cuid().optional(),
  string: z.string().min(3, { message: "min error" }).max(10, { message: "max error" }).optional().nullable(),
  bic: z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }).optional().nullable(),
  float: z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }),
...
export const MyPrismaScalarsTypeUpdateManyMutationInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUpdateManyMutationInput> = z.object({
  id: z.union([z.string({ invalid_type_error: "invalid type error" }).cuid(), z.lazy(() => StringFieldUpdateOperationsInput)]).optional(),
  string: z.union([z.string().min(3, { message: "min error" }).max(10, { message: "max error" }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  bic: z.union([z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  float: z.union([z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }), z.lazy(() => FloatFieldUpdateOperationsInput)]).optional(),
...
export const MyPrismaScalarsTypeUncheckedUpdateManyInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUncheckedUpdateManyInput> = z.object({
  id: z.union([z.string({ invalid_type_error: "invalid type error" }).cuid(), z.lazy(() => StringFieldUpdateOperationsInput)]).optional(),
  string: z.union([z.string().min(3, { message: "min error" }).max(10, { message: "max error" }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  bic: z.union([z.string().refine((val) => validator.isBIC(val), { message: 'BIC is not valid' }), z.lazy(() => NullableStringFieldUpdateOperationsInput)]).optional().nullable(),
  float: z.union([z.number().lt(10, { message: "lt error" }).gt(5, { message: "gt error" }), z.lazy(() => FloatFieldUpdateOperationsInput)]).optional(),
...
export const MyModelCountOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyModelCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyModelAvgOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyModelAvgOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyModelMaxOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyModelMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyModelMinOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyModelMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  custom: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyModelSumOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyModelSumOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
}).strict();
...
export const MyPrismaScalarsTypeCountOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  string: z.lazy(() => SortOrder).optional(),
  bic: z.lazy(() => SortOrder).optional(),
  float: z.lazy(() => SortOrder).optional(),
...
export const MyPrismaScalarsTypeAvgOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeAvgOrderByAggregateInput> = z.object({
  float: z.lazy(() => SortOrder).optional(),
  decimal: z.lazy(() => SortOrder).optional(),
  bigInt: z.lazy(() => SortOrder).optional(),
}).strict();

export const MyPrismaScalarsTypeMaxOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  string: z.lazy(() => SortOrder).optional(),
  bic: z.lazy(() => SortOrder).optional(),
  float: z.lazy(() => SortOrder).optional(),
...
export const MyPrismaScalarsTypeMinOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrder).optional(),
  string: z.lazy(() => SortOrder).optional(),
  bic: z.lazy(() => SortOrder).optional(),
  float: z.lazy(() => SortOrder).optional(),
...
export const MyPrismaScalarsTypeSumOrderByAggregateInput: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeSumOrderByAggregateInput> = z.object({
  float: z.lazy(() => SortOrder).optional(),
  decimal: z.lazy(() => SortOrder).optional(),
  bigInt: z.lazy(() => SortOrder).optional(),
}).strict();
...
export const MyModelFindFirstArgs: z.ZodType<Prisma.Prisma.MyModelFindFirstArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereInput.optional(),
  orderBy: z.union([MyModelOrderByWithRelationInput.array(), MyModelOrderByWithRelationInput]).optional(),
  cursor: MyModelWhereUniqueInput.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: MyModelScalarFieldEnum.array().optional(),
}).strict();

export const MyModelFindManyArgs: z.ZodType<Prisma.Prisma.MyModelFindManyArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereInput.optional(),
  orderBy: z.union([MyModelOrderByWithRelationInput.array(), MyModelOrderByWithRelationInput]).optional(),
  cursor: MyModelWhereUniqueInput.optional(),
...
export const MyModelAggregateArgs: z.ZodType<Prisma.Prisma.MyModelAggregateArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereInput.optional(),
  orderBy: z.union([MyModelOrderByWithRelationInput.array(), MyModelOrderByWithRelationInput]).optional(),
  cursor: MyModelWhereUniqueInput.optional(),
...
export const MyModelGroupByArgs: z.ZodType<Prisma.Prisma.MyModelGroupByArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereInput.optional(),
  orderBy: z.union([MyModelOrderByWithAggregationInput.array(), MyModelOrderByWithAggregationInput]).optional(),
  by: MyModelScalarFieldEnum.array(),
  having: MyModelScalarWhereWithAggregatesInput.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict();

export const MyModelFindUniqueArgs: z.ZodType<Prisma.Prisma.MyModelFindUniqueArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
...
export const MyPrismaScalarsTypeFindFirstArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeFindFirstArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereInput.optional(),
  orderBy: z.union([MyPrismaScalarsTypeOrderByWithRelationInput.array(), MyPrismaScalarsTypeOrderByWithRelationInput]).optional(),
...
export const MyPrismaScalarsTypeFindManyArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeFindManyArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereInput.optional(),
  orderBy: z.union([MyPrismaScalarsTypeOrderByWithRelationInput.array(), MyPrismaScalarsTypeOrderByWithRelationInput]).optional(),
  cursor: MyPrismaScalarsTypeWhereUniqueInput.optional(),
...
export const MyPrismaScalarsTypeAggregateArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeAggregateArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereInput.optional(),
  orderBy: z.union([MyPrismaScalarsTypeOrderByWithRelationInput.array(), MyPrismaScalarsTypeOrderByWithRelationInput]).optional(),
  cursor: MyPrismaScalarsTypeWhereUniqueInput.optional(),
...
export const MyPrismaScalarsTypeGroupByArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeGroupByArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereInput.optional(),
  orderBy: z.union([MyPrismaScalarsTypeOrderByWithAggregationInput.array(), MyPrismaScalarsTypeOrderByWithAggregationInput]).optional(),
...
export const MyPrismaScalarsTypeFindUniqueArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeFindUniqueArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
...
export const MyModelCreateArgs: z.ZodType<Prisma.Prisma.MyModelCreateArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  data: z.union([MyModelCreateInput, MyModelUncheckedCreateInput]),
}).strict();

export const MyModelUpsertArgs: z.ZodType<Prisma.Prisma.MyModelUpsertArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereUniqueInput,
  create: z.union([MyModelCreateInput, MyModelUncheckedCreateInput]),
  update: z.union([MyModelUpdateInput, MyModelUncheckedUpdateInput]),
}).strict();

export const MyModelCreateManyArgs: z.ZodType<Prisma.Prisma.MyModelCreateManyArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  data: MyModelCreateManyInput.array(),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const MyModelDeleteArgs: z.ZodType<Prisma.Prisma.MyModelDeleteArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereUniqueInput,
}).strict();

export const MyModelUpdateArgs: z.ZodType<Prisma.Prisma.MyModelUpdateArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  data: z.union([MyModelUpdateInput, MyModelUncheckedUpdateInput]),
  where: MyModelWhereUniqueInput,
}).strict();

export const MyModelUpdateManyArgs: z.ZodType<Prisma.Prisma.MyModelUpdateManyArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  data: z.union([MyModelUpdateManyMutationInput, MyModelUncheckedUpdateManyInput]),
  where: MyModelWhereInput.optional(),
}).strict();

export const MyModelDeleteManyArgs: z.ZodType<Prisma.Prisma.MyModelDeleteManyArgs> = z.object({
  select: z.lazy(() => MyModelSelect).optional(),
  where: MyModelWhereInput.optional(),
}).strict();
...
export const MyPrismaScalarsTypeCreateArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeCreateArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  data: z.union([MyPrismaScalarsTypeCreateInput, MyPrismaScalarsTypeUncheckedCreateInput]),
}).strict();

export const MyPrismaScalarsTypeUpsertArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUpsertArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereUniqueInput,
  create: z.union([MyPrismaScalarsTypeCreateInput, MyPrismaScalarsTypeUncheckedCreateInput]),
  update: z.union([MyPrismaScalarsTypeUpdateInput, MyPrismaScalarsTypeUncheckedUpdateInput]),
}).strict();

export const MyPrismaScalarsTypeCreateManyArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeCreateManyArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  data: MyPrismaScalarsTypeCreateManyInput.array(),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const MyPrismaScalarsTypeDeleteArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeDeleteArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereUniqueInput,
}).strict();

export const MyPrismaScalarsTypeUpdateArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUpdateArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  data: z.union([MyPrismaScalarsTypeUpdateInput, MyPrismaScalarsTypeUncheckedUpdateInput]),
  where: MyPrismaScalarsTypeWhereUniqueInput,
}).strict();

export const MyPrismaScalarsTypeUpdateManyArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeUpdateManyArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  data: z.union([MyPrismaScalarsTypeUpdateManyMutationInput, MyPrismaScalarsTypeUncheckedUpdateManyInput]),
  where: MyPrismaScalarsTypeWhereInput.optional(),
}).strict();

export const MyPrismaScalarsTypeDeleteManyArgs: z.ZodType<Prisma.Prisma.MyPrismaScalarsTypeDeleteManyArgs> = z.object({
  select: z.lazy(() => MyPrismaScalarsTypeSelect).optional(),
  where: MyPrismaScalarsTypeWhereInput.optional(),
}).strict();
