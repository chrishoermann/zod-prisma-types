...
export const isValidDecimalInput = (v: string | number | PrismaClient.Prisma.Decimal | DecimalJsLike): v is number | string =>
  typeof v === 'number' ||
  (typeof v === 'string' && DECIMAL_STRING_REGEX.test(v));

export const isValidDecimalListInput = (v: string[] | number[] | PrismaClient.Prisma.Decimal[] | DecimalJsLike[]): v is number[] | string[] =>
  (v as number[]).every((v) => typeof v === 'number') ||
  (v as string[]).every((v) => typeof v === 'string' && DECIMAL_STRING_REGEX.test(v));

export const isDecimalJsLike = (v: unknown): v is DecimalJsLike => !!v && typeof v === 'object' && 'd' in v && 'e' in v && 's' in v;
...
export const MyPrismaScalarsTypeSchema = z.object({
  ...
  decimal: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Field "decimal" must be a Decimal', path: ['Models', 'MyPrismaScalarsType'] }),
  decimalOpt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Field "decimalOpt" must be a Decimal', path: ['Models', 'MyPrismaScalarsType'] }).nullish(),
  date: z.date(),
...
export const WithDefaultValidatorsOptionalDefaultsSchema = WithDefaultValidatorsSchema.merge(
  z.object({
    id: z.string().cuid().optional(),
...
export const DecimalModelSchema = z.object({
  id: z.number().int(),
  decimal: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Field "decimal" must be a Decimal', path: ['Models', 'DecimalModel'] }),
  decimalOpt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Field "decimalOpt" must be a Decimal', path: ['Models', 'DecimalModel'] }).nullish(),
});
...
export const NonDefaultModelSelectSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelSelect> = z.object({
  id: z.boolean().optional(),
  string: z.boolean().optional(),
}).strict();
...
export const WithDefaultValidatorsSelectSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsSelect> = z.object({
  id: z.boolean().optional(),
...
export const MyPrismaScalarsTypeWhereInputSchema: z.ZodType<PrismaClient.Prisma.MyPrismaScalarsTypeWhereInput> = z.object({
  ...
  decimal: z.union([z.lazy(() => DecimalFilterSchema), z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' })]).optional(),
  decimalOpt: z.union([z.lazy(() => DecimalNullableFilterSchema), z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' })]).optional().nullable(),
...
export const MyPrismaScalarsTypeScalarWhereWithAggregatesInputSchema: z.ZodType<PrismaClient.Prisma.MyPrismaScalarsTypeScalarWhereWithAggregatesInput> = z.object({
  ...
  decimal: z.union([z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' })]).optional(),
  decimalOpt: z.union([z.lazy(() => DecimalNullableWithAggregatesFilterSchema), z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' })]).optional().nullable(),
...
export const MyPrismaScalarsTypeCreateInputSchema: z.ZodType<Omit<PrismaClient.Prisma.MyPrismaScalarsTypeCreateInput, "exclude">> = z.object({
  ...
  decimal: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }),
  decimalOpt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional().nullable(),
  date: z.date().optional(),
...
export const MyPrismaScalarsTypeUpdateInputSchema: z.ZodType<Omit<PrismaClient.Prisma.MyPrismaScalarsTypeUpdateInput, "exclude">> = z.object({
  ...
  decimal: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => DecimalFieldUpdateOperationsInputSchema)]).optional(),
  decimalOpt: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => NullableDecimalFieldUpdateOperationsInputSchema)]).optional().nullable(),
...
export const DecimalFilterSchema: z.ZodType<PrismaClient.Prisma.DecimalFilter> = z.object({
  equals: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  in: z.union([z.number().array(), z.string().array(), z.instanceof(PrismaClient.Prisma.Decimal).array(), DecimalJSLikeSchema.array(),]).transform((v) => isValidDecimalListInput(v) ? v.map((v) => new PrismaClient.Prisma.Decimal(v)) : v).refine((v) => v.every((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v)), { message: 'Must be a Decimal' }).optional(),
  notIn: z.union([z.number().array(), z.string().array(), z.instanceof(PrismaClient.Prisma.Decimal).array(), DecimalJSLikeSchema.array(),]).transform((v) => isValidDecimalListInput(v) ? v.map((v) => new PrismaClient.Prisma.Decimal(v)) : v).refine((v) => v.every((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v)), { message: 'Must be a Decimal' }).optional(),
  lt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  lte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  not: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => NestedDecimalFilterSchema)]).optional(),
}).strict();

export const DecimalNullableFilterSchema: z.ZodType<PrismaClient.Prisma.DecimalNullableFilter> = z.object({
  equals: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional().nullable(),
  in: z.union([z.number().array(), z.string().array(), z.instanceof(PrismaClient.Prisma.Decimal).array(), DecimalJSLikeSchema.array(),]).transform((v) => isValidDecimalListInput(v) ? v.map((v) => new PrismaClient.Prisma.Decimal(v)) : v).refine((v) => v.every((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v)), { message: 'Must be a Decimal' }).optional().nullable(),
  notIn: z.union([z.number().array(), z.string().array(), z.instanceof(PrismaClient.Prisma.Decimal).array(), DecimalJSLikeSchema.array(),]).transform((v) => isValidDecimalListInput(v) ? v.map((v) => new PrismaClient.Prisma.Decimal(v)) : v).refine((v) => v.every((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v)), { message: 'Must be a Decimal' }).optional().nullable(),
  lt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  lte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  not: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => NestedDecimalNullableFilterSchema)]).optional().nullable(),
}).strict();
...
export const DecimalWithAggregatesFilterSchema: z.ZodType<PrismaClient.Prisma.DecimalWithAggregatesFilter> = z.object({
  ...
  gt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  not: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => NestedDecimalWithAggregatesFilterSchema)]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const DecimalNullableWithAggregatesFilterSchema: z.ZodType<PrismaClient.Prisma.DecimalNullableWithAggregatesFilter> = z.object({
  ...
  gt: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  gte: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  not: z.union([z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }), z.lazy(() => NestedDecimalNullableWithAggregatesFilterSchema)]).optional().nullable(),
  _count: z.lazy(() => NestedIntNullableFilterSchema).optional(),
...
export const DecimalFieldUpdateOperationsInputSchema: z.ZodType<PrismaClient.Prisma.DecimalFieldUpdateOperationsInput> = z.object({
  set: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  increment: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  decrement: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  multiply: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  divide: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
}).strict();
...
export const NullableDecimalFieldUpdateOperationsInputSchema: z.ZodType<PrismaClient.Prisma.NullableDecimalFieldUpdateOperationsInput> = z.object({
  set: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional().nullable(),
  increment: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  decrement: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  multiply: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
  divide: z.union([z.number(), z.string(), z.instanceof(PrismaClient.Prisma.Decimal), DecimalJSLikeSchema,]).transform((v) => isValidDecimalInput(v) ? new PrismaClient.Prisma.Decimal(v) : v).refine((v) => PrismaClient.Prisma.Decimal.isDecimal(v) || isDecimalJsLike(v), { message: 'Must be a Decimal' }).optional(),
...
export const NonDefaultModelFindFirstArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelFindFirstArgs> = z.object({
...
export const NonDefaultModelFindFirstOrThrowArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelFindFirstOrThrowArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereInputSchema.optional(),
  orderBy: z.union([NonDefaultModelOrderByWithRelationInputSchema.array(), NonDefaultModelOrderByWithRelationInputSchema]).optional(),
  cursor: NonDefaultModelWhereUniqueInputSchema.optional(),
...
export const NonDefaultModelFindManyArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelFindManyArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereInputSchema.optional(),
  orderBy: z.union([NonDefaultModelOrderByWithRelationInputSchema.array(), NonDefaultModelOrderByWithRelationInputSchema]).optional(),
  cursor: NonDefaultModelWhereUniqueInputSchema.optional(),
...
export const NonDefaultModelAggregateArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelAggregateArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereInputSchema.optional(),
  orderBy: z.union([NonDefaultModelOrderByWithRelationInputSchema.array(), NonDefaultModelOrderByWithRelationInputSchema]).optional(),
  cursor: NonDefaultModelWhereUniqueInputSchema.optional(),
...
export const NonDefaultModelGroupByArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelGroupByArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereInputSchema.optional(),
...
export const NonDefaultModelFindUniqueArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelFindUniqueArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereUniqueInputSchema,
}).strict();

export const NonDefaultModelFindUniqueOrThrowArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelFindUniqueOrThrowArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereUniqueInputSchema,
}).strict();

export const WithDefaultValidatorsFindFirstArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsFindFirstArgs> = z.object({
...
export const WithDefaultValidatorsFindFirstOrThrowArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsFindFirstOrThrowArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereInputSchema.optional(),
  orderBy: z.union([WithDefaultValidatorsOrderByWithRelationInputSchema.array(), WithDefaultValidatorsOrderByWithRelationInputSchema]).optional(),
  cursor: WithDefaultValidatorsWhereUniqueInputSchema.optional(),
...
export const WithDefaultValidatorsFindManyArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsFindManyArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereInputSchema.optional(),
  orderBy: z.union([WithDefaultValidatorsOrderByWithRelationInputSchema.array(), WithDefaultValidatorsOrderByWithRelationInputSchema]).optional(),
  cursor: WithDefaultValidatorsWhereUniqueInputSchema.optional(),
...
export const WithDefaultValidatorsAggregateArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsAggregateArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereInputSchema.optional(),
  orderBy: z.union([WithDefaultValidatorsOrderByWithRelationInputSchema.array(), WithDefaultValidatorsOrderByWithRelationInputSchema]).optional(),
  cursor: WithDefaultValidatorsWhereUniqueInputSchema.optional(),
...
export const WithDefaultValidatorsGroupByArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsGroupByArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereInputSchema.optional(),
...
export const WithDefaultValidatorsFindUniqueArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsFindUniqueArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereUniqueInputSchema,
}).strict();

export const WithDefaultValidatorsFindUniqueOrThrowArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsFindUniqueOrThrowArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereUniqueInputSchema,
}).strict();
...
export const NonDefaultModelCreateArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelCreateArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  data: z.union([NonDefaultModelCreateInputSchema, NonDefaultModelUncheckedCreateInputSchema]),
}).strict();

export const NonDefaultModelUpsertArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelUpsertArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereUniqueInputSchema,
...
export const NonDefaultModelCreateManyArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelCreateManyArgs> = z.object({
  data: NonDefaultModelCreateManyInputSchema.array(),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const NonDefaultModelDeleteArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelDeleteArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  where: NonDefaultModelWhereUniqueInputSchema,
}).strict();

export const NonDefaultModelUpdateArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelUpdateArgs> = z.object({
  select: NonDefaultModelSelectSchema.optional(),
  data: z.union([NonDefaultModelUpdateInputSchema, NonDefaultModelUncheckedUpdateInputSchema]),
  where: NonDefaultModelWhereUniqueInputSchema,
}).strict();

export const NonDefaultModelUpdateManyArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelUpdateManyArgs> = z.object({
  data: z.union([NonDefaultModelUpdateManyMutationInputSchema, NonDefaultModelUncheckedUpdateManyInputSchema]),
  where: NonDefaultModelWhereInputSchema.optional(),
}).strict();

export const NonDefaultModelDeleteManyArgsSchema: z.ZodType<PrismaClient.Prisma.NonDefaultModelDeleteManyArgs> = z.object({
  where: NonDefaultModelWhereInputSchema.optional(),
}).strict();

export const WithDefaultValidatorsCreateArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsCreateArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  data: z.union([WithDefaultValidatorsCreateInputSchema, WithDefaultValidatorsUncheckedCreateInputSchema]),
}).strict();

export const WithDefaultValidatorsUpsertArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsUpsertArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereUniqueInputSchema,
...
export const WithDefaultValidatorsCreateManyArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsCreateManyArgs> = z.object({
  data: WithDefaultValidatorsCreateManyInputSchema.array(),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const WithDefaultValidatorsDeleteArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsDeleteArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  where: WithDefaultValidatorsWhereUniqueInputSchema,
}).strict();

export const WithDefaultValidatorsUpdateArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsUpdateArgs> = z.object({
  select: WithDefaultValidatorsSelectSchema.optional(),
  data: z.union([WithDefaultValidatorsUpdateInputSchema, WithDefaultValidatorsUncheckedUpdateInputSchema]),
  where: WithDefaultValidatorsWhereUniqueInputSchema,
}).strict();

export const WithDefaultValidatorsUpdateManyArgsSchema: z.ZodType<PrismaClient.Prisma.WithDefaultValidatorsUpdateManyArgs> = z.object({
