...
export const MyPrismaScalarsTypeUncheckedCreateInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeUncheckedCreateInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeUncheckedCreateInputSchema
