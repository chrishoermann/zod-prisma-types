...
export const ModelWithOmitFieldsUpdateInputSchema: z.ZodType<Omit<Prisma.ModelWithOmitFieldsUpdateInput, "omitField" | "omitRequired">> = z.object({
...
export default ModelWithOmitFieldsUpdateInputSchema
