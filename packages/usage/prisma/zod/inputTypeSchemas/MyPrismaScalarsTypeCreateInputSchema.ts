...
export const MyPrismaScalarsTypeCreateInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeCreateInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeCreateInputSchema
