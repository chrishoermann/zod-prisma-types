...
export const EnumAnotherEnumWithAggregatesFilterSchema: z.ZodType<Prisma.EnumAnotherEnumWithAggregatesFilter> = z.object({
...
export default EnumAnotherEnumWithAggregatesFilterSchema
