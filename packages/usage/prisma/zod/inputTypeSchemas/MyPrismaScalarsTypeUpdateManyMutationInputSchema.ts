...
export const MyPrismaScalarsTypeUpdateManyMutationInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeUpdateManyMutationInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeUpdateManyMutationInputSchema
