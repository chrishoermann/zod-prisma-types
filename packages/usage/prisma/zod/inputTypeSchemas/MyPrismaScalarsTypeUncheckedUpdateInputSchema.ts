...
export const MyPrismaScalarsTypeUncheckedUpdateInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeUncheckedUpdateInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeUncheckedUpdateInputSchema
