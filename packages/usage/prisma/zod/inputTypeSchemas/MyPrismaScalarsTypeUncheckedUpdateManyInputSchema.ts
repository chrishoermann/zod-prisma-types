...
export const MyPrismaScalarsTypeUncheckedUpdateManyInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeUncheckedUpdateManyInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeUncheckedUpdateManyInputSchema
