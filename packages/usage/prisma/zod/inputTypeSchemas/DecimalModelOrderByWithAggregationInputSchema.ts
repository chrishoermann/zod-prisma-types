...
export const DecimalModelOrderByWithAggregationInputSchema: z.ZodType<Prisma.DecimalModelOrderByWithAggregationInput> = z.object({
...
export default DecimalModelOrderByWithAggregationInputSchema
