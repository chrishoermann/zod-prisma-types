...
export const MyPrismaScalarsTypeSumOrderByAggregateInputSchema: z.ZodType<Prisma.MyPrismaScalarsTypeSumOrderByAggregateInput> = z.object({
...
export default MyPrismaScalarsTypeSumOrderByAggregateInputSchema
