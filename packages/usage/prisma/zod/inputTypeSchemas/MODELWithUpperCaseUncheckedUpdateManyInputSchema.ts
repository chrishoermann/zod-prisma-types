...
export const MODELWithUpperCaseUncheckedUpdateManyInputSchema: z.ZodType<Prisma.MODELWithUpperCaseUncheckedUpdateManyInput> = z.object({
...
export default MODELWithUpperCaseUncheckedUpdateManyInputSchema
