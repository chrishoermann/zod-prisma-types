...
export const ModelWithCommentsUncheckedUpdateManyInputSchema: z.ZodType<Omit<Prisma.ModelWithCommentsUncheckedUpdateManyInput, "omitField" | "omitRequired">> = z.object({
...
export default ModelWithCommentsUncheckedUpdateManyInputSchema
