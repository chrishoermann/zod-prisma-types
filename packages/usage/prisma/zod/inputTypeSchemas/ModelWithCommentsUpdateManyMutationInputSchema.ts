...
export const ModelWithCommentsUpdateManyMutationInputSchema: z.ZodType<Omit<Prisma.ModelWithCommentsUpdateManyMutationInput, "omitField" | "omitRequired">> = z.object({
...
export default ModelWithCommentsUpdateManyMutationInputSchema
