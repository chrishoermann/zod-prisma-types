...
export const MyPrismaScalarsTypeMinOrderByAggregateInputSchema: z.ZodType<Prisma.MyPrismaScalarsTypeMinOrderByAggregateInput> = z.object({
...
export default MyPrismaScalarsTypeMinOrderByAggregateInputSchema
