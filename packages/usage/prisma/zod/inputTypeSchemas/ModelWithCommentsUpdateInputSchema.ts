...
export const ModelWithCommentsUpdateInputSchema: z.ZodType<Omit<Prisma.ModelWithCommentsUpdateInput, "omitField" | "omitRequired">> = z.object({
...
export default ModelWithCommentsUpdateInputSchema
