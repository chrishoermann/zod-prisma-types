...
export const MyPrismaScalarsTypeUpdateInputSchema: z.ZodType<Omit<Prisma.MyPrismaScalarsTypeUpdateInput, "exclude">> = z.object({
...
export default MyPrismaScalarsTypeUpdateInputSchema
