...
exports.PRISMA_FUNCTION_TYPES_WITH_VALIDATORS = exports.DATE_VALIDATOR_NUMBER_AND_MESSAGE_REGEX = exports.NUMBER_VALIDATOR_MESSAGE_REGEX = exports.NUMBER_VALIDATOR_NUMBER_AND_MESSAGE_REGEX = exports.STRING_VALIDATOR_STRING_AND_MESSAGE_REGEX = exports.STRING_VALIDATOR_REGEX = exports.STRING_VALIDATOR_MESSAGE_REGEX = exports.STRING_VALIDATOR_NUMBER_AND_MESSAGE_REGEX = exports.VALIDATOR_CUSTOM_ERROR_REGEX = exports.VALIDATOR_KEY_REGEX = exports.SPLIT_VALIDATOR_PATTERN_REGEX = exports.VALIDATOR_TYPE_REGEX = void 0;
exports.VALIDATOR_TYPE_REGEX = /@zod\.(?<type>string|number|bigint|date){1}(?<customErrors>\({[\w"': ,%&/()=?$§!,_#@><°^+*~-]+}\))?(?<validatorPattern>.*)?/;
exports.SPLIT_VALIDATOR_PATTERN_REGEX = /(\.[\w"': ,%&/()=?$§!,_#@><°^+*~{}-]+)/g;
exports.VALIDATOR_KEY_REGEX = /(\.(?<validatorKey>[\w]+))/;
exports.VALIDATOR_CUSTOM_ERROR_REGEX = /(?<opening>\(\{)(?<messages>[\w,": ]+)(?<closing>\}\))/;
