...
export declare const PRISMA_TO_VALIDATOR_TYPE_MAP: KeyValueMap<
  ZodValidatorType | 'custom',
  PrismaScalarType[]
>;
export declare const PRISMA_TO_ZOD_TYPE_MAP: KeyValueMap<
  ZodPrismaScalarType,
  ZodScalarType
>;
...
>;
export declare const PRISMA_ACTION_ARG_MAP: KeyValueMap<
  FilterdPrismaAction,
  FormattedNames
>;
